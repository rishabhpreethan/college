...
<body>
    <?php
        ...
        $result=mysqli_query($con,"select * from user_detail where emp_id='$name'"); 
        ...
        {
            echo "<i style='color:blue'>num of rows in the user_detail table with user name as $name are $rows</i><br/>";
